import { S3Client, CompleteMultipartUploadCommand, ListPartsCommand, CreateMultipartUploadCommand, UploadPartCommand } from '@aws-sdk/client-s3';
...
export const uploadPart = async (key, uploadId, partNumber, body) => {
  try {
    ...
    console.log('Upload part etag: ', ETag)
    return ETag;
  } catch (error) {
